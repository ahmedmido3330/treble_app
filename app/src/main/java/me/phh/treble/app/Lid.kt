...
object Lid: EntryStartup {
    ...
    fun lenovo(ctxt: Context) {
        val sensorManager = ctxt.getSystemService(SensorManager::class.java)
        val sensors = listOf("ah1902 Hall Effect Sensor Wakeup", "bu52053nvx Hall Effect Sensor Wakeup", "mmc56x3x Hall Effect Sensor Wakeup", "qmc630x Hall Effect Sensor Wakeup", "qmc6308 Hall Effect Sensor Wakeup"))
